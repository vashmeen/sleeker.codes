const Page = () => {
  return (
    <div>
      ...
      <p>Sleeker (for now) use <a href="https://www.radix-ui.com/colors">Radix Colors</a> under the hood.</p>
      <p>Radix colors are a color pallet with 20 scales. It is built with accessibility in mind.</p>
